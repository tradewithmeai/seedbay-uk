    ...
    <footer className="bg-gray-50 border-t border-gray-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-bold text-primary-700 mb-2">SeedBay.co.uk</h3>
            <p className="text-gray-600 text-sm">
              A community board for seed exchange across the UK.
              Connect directly — no middleman, no fees.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} SeedBay.co.uk. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
